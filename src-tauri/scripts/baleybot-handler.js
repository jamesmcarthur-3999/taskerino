#!/usr/bin/env node
/**
 * Baleybot Handler Script
 * 
 * Runs inside Tauri backend and listens for Tauri events.
 * Uses baleybots' createHandlers() to get handler functions that process requests.
 * Routes requests to providers and sends responses back via Tauri events.
 * 
 * No HTTP server needed - just uses handlers directly!
 */
...
// Rust will set these via process.env before spawning
const apiKeys = {
...
// Create handlers using baleybots (no HTTP server!)
